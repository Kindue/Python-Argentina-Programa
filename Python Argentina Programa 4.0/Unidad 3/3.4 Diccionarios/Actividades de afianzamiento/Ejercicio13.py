...
print("Pero podemos convertir los elementos de un diccionario a una lista para hacer las zancadas necesarias")
...
for i in d.items():
	lista.append(i)
print("Lista de elementos del diccionario d", lista)
